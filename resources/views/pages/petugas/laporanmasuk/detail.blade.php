        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/laporanmasukpetugas" class="btn float-right btn-outline-warning btn-md">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <form action="{{ route('laporanmasukpetugas.updateStatusPetugas', $laporan->id) }}" method="POST">
                                        @csrf
